...
<html lang="en">
    <head>
        ...
        <body>
            <nav class="navbar navbar-expand-md navbar-dark bg-dark mb-0">
                <a class="navbar-brand" href="../../index.html"> Immobilier sur mesure</a>
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="score.php" style="font-size: small;vertical-align: baseline;padding-top:13px;"><em>Retourner à la page du score</em>
                                <span class="sr-only">(current)</span></a>
                            </li>
                        <!--<li class="nav-item">
                            <a class="nav-link" href="#" style="font-size: small;vertical-align: baseline;padding-top:13px;"><em>Retourner à la page du score</em>
                                <span class="sr-only">(current)</span></a>
                            </li>-->
                    </ul>
                </div>
            </nav>
        <div class="container-fluid" style="position: fixed; padding: 0px !important">
    ...
    if (retourdangerinon){
        for (let i = 0; i < retourdangerinon.length; i++) {

            let lelabel = "Danger:<br> " + String(retourdangerinon[i].label);
            //console.log(lelabel);
    ...
    controleur.setPosition('topleft');
